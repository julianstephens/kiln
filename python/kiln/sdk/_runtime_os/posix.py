"""
3rd party POSIX-specific stdio client helper from https://github.com/modelcontextprotocol/python-sdk/blob/main/src/mcp/os/posix/utilities.py
"""
...
async def terminate_posix_process_tree(
    ...
    try:
        ...
        logger.warning(
            (
                "No permission to signal some of process group %d; "
                "waiting for it to exit anyway"
            ),
            pgid,
            exc_info=True,
        )
